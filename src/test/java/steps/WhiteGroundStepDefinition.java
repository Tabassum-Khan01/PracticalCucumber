...
public class WhiteGroundStepDefinition extends TestBase {
	...
	public void user_clicks_on_the_button(String SkyBlue) {
		backgroundPage.clickSkyBlueButton();
	}
	
	@And("User clicks on the {string} button")
	public void user_cicks_on_the_white_button(String White) {
